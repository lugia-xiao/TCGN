...
class ViT_HER2ST(torch.utils.data.Dataset):
    ...
    def __init__(self, train=True, fold=0, r=4, flatten=True, ori=False, adj=False, prune='Grid', neighs=4):
        ...
        samples = names[1:33]
        patients=[samples[0:5],samples[5:11],samples[11:17],samples[17:23],samples[23:26],samples[26:29],samples[29:]]

        te_names = patients[fold]
        print(te_names)
        ...
        if not train and self.names[1] in ['A1', 'B1', 'C1', 'D1', 'E1', 'F1', 'G2', 'H1', 'J1']:
...
def pk_load(fold,mode='train',flatten=False,dataset_name='her2st',r=4,ori=True,adj=True,prune='Grid',neighs=4):
    assert dataset_name in ['her2st','cscc']
    dataset=None
